	...
	<div class="gp-migration-guide">
		...
		<div class="gp-migration-guide__section">
			...
			<ol class="gp-migration-guide__steps">
				...
				<li><strong><?php esc_html_e( 'Venue linking', 'telex-gatherpress-migration' ); ?></strong> &mdash; <?php esc_html_e( 'Venue references (_EventVenueID) are resolved using the WordPress Importer old-to-new ID mapping. The new venue post ID is then linked to the event via the _gatherpress_venue shadow taxonomy — the same mechanism GatherPress uses natively. Venues must be imported as gatherpress_venue posts first so the shadow taxonomy terms exist. Taxonomy-based venues (e.g., Event Organiser event-venue terms) are handled by the standard WXR taxonomy import and require manual conversion to gatherpress_venue posts.', 'telex-gatherpress-migration' ); ?></li>
			</ol>
		</div>
				...
				<table class="gp-migration-guide__table">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php esc_html_e( 'gatherpress_venue post + _gatherpress_venue taxonomy', 'telex-gatherpress-migration' ); ?></td>
							<td><?php esc_html_e( 'Post type rewrite + ID mapping + shadow taxonomy term assignment', 'telex-gatherpress-migration' ); ?></td>
						</tr>
						<tr>
		...
		<div class="gp-migration-guide__section">
			...
			<ul class="gp-migration-guide__list">
				...
				<li><strong><?php esc_html_e( 'Import order', 'telex-gatherpress-migration' ); ?></strong> &mdash; <?php esc_html_e( 'Venues MUST be imported before events. GatherPress creates gatherpress_venue posts that are automatically shadowed into the hidden _gatherpress_venue taxonomy. Events reference venues via this taxonomy. If venues are not imported first, the shadow terms will not exist and venue linking will fail.', 'telex-gatherpress-migration' ); ?></li>
